...
| Folder   | Description                                      |
| -------- | ------------------------------------------------ |
| electron | Electron main process folder (NodeJS)            |
...
| `npm run web:build`      | Build the app that can be used directly in the web browser. Your build files are in the /dist folder. |
